...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredOptional1() {
    // Have each person have different events and one optional having an event for the whole day. 
    // We should see 3 options because each person has
    // split the restricted times, ignoring the optional.
    //
    // Events  :       |--A--|     |--B--|
    //           |-------------C---------------|
    // Day     : |-----------------------------|
  ...
  public void everyAttendeeIsConsideredOptional2() {
    // Have each person have different events, and the gap between be an event for the optional. 
  ...
  public void justEnoughRoomOptional() {
    // Have one person and one optional, but make it so that there is just enough room for A.
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|
    // Day     : |---------------------|
  ...
  public void onlyOptional () {
    // Have 2 optional people, the result should be the gaps both have in common.
    //
    // Events  : |--A--|    |-----A----|
    //              |-B--|    
    // Day     : |---------------------|
  ...
  public void onlyOptionalNoRoom () {
    // Have 2 optional people, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Events  : |--A------||-----A----|
    //           |-----B-------||----B-|    
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0930AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_1100AM, false),
            Arrays.asList(PERSON_B)),
